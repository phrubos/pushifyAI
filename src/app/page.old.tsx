      ...
      <section className="bg-muted/30 py-16 md:py-24">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto mb-12">
            <div className="relative rounded-xl overflow-hidden border-2 border-primary/20 bg-background shadow-xl">
              <div className="absolute top-4 left-4 z-10">
                <span className="inline-flex items-center gap-2 rounded-full bg-primary px-4 py-1.5 text-sm font-semibold text-primary-foreground shadow-lg">
            ...
            <p className="text-center text-muted-foreground mt-4 text-lg font-medium">
